...
Set-Alias -Name s -Value "C:\Program Files (x86)\Everything\Everything.exe"
Set-Alias -Name vbox -Value "C:\Program Files\Oracle\VirtualBox\VirtualBox.exe"
Set-Alias -Name iis -Value "C:\Windows\System32\inetsrv\InetMgr.exe"
